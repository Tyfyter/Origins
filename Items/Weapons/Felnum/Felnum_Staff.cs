...
namespace Origins.Items.Weapons.Felnum {
    public class Felnum_Staff : ModItem {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack) {
            ...
            damage+=(damage-19)/2;
            Projectile.NewProjectile(position, speed.RotatedByRandom(1f)*Main.rand.NextFloat(0.9f,1.1f), type, damage, knockBack, item.owner, speed.ToRotation(), Main.rand.NextFloat());
            return false;
        }
    }
