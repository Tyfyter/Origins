...
namespace Origins.Items.Weapons.Magic {
    public class Gravaulter : ModItem {
        ...
        public override void SetStaticDefaults() {
            ...
            Tooltip.SetDefault("Pull in space rock and launch it");
        ...
        public override void SetStaticDefaults() {
            ...
            if (!Main.dedServ) {
                RockTextures = new AutoCastingAsset<Texture2D>[]{
                    Mod.Assets.Request<Texture2D>("Items/Weapons/Magic/Gravaulter_P"),
                    Mod.Assets.Request<Texture2D>("Items/Weapons/Magic/Gravaulter_P2"),
                    Mod.Assets.Request<Texture2D>("Items/Weapons/Magic/Gravaulter_P3")
                };
            }
        }
        public override void SetDefaults() {
    ...
    public class Gravaulter_Rock1 : Gravaulter_Rock {
        public override string Texture => "Origins/Items/Weapons/Magic/Gravaulter_P";
        public static int ID { get; private set; }
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Space Rock");
            ID = Projectile.type;
    ...
    public class Gravaulter_Rock2 : Gravaulter_Rock {
        public override string Texture => "Origins/Items/Weapons/Magic/Gravaulter_P2";
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Space Rock");
        }
    }
    public class Gravaulter_Rock3 : Gravaulter_Rock {
        public override string Texture => "Origins/Items/Weapons/Magic/Gravaulter_P3";
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Space Rock");
        }
    }
