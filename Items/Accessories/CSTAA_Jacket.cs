...
namespace Origins.Items.Accessories {
	...
	public class CSTAA_Jacket : ModItem, ICustomWikiStat {
		...
		public override void UpdateAccessory(Player player, bool hideVisual) {
			...
			player.OriginPlayer().flakDashJacketItem = Item;
		}
		public override bool WeaponPrefix() => true;
	}
	public class CSTAA_Jacket_Explosion : ExplosionProjectile {
		...
		public override void AI() {
			if (Projectile.ai[0] == 0) {
				CSTAA_Jacket_Flak_1[] projectiles = Mod.GetContent<CSTAA_Jacket_Flak_1>().ToArray();
	...
	public class CSTAA_Jacket_Flak_1 : ModProjectile {
	...
	public class CSTAA_Jacket_Flak_2 : CSTAA_Jacket_Flak_1 {
		public override string Texture => typeof(Shardcannon_P2).GetDefaultTMLName();
	}
	public class CSTAA_Jacket_Flak_3 : CSTAA_Jacket_Flak_1 {
