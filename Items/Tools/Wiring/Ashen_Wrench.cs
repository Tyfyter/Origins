...
namespace Origins.Items.Tools.Wiring {
	public class Screwdriver : WireTool {
		public override IEnumerable<WireMode> Modes => WireModeLoader.GetSorted(WireMode.Sets.AshenWires);
	...
	public class Screwdriver_White : Screwdriver {
		public override IEnumerable<WireMode> Modes => base.Modes.Concat(WireModeLoader.GetSorted(WireMode.Sets.GreaterAshenWires));
	...
	public class Ashen_Grand_Design : WireTool {
		public override IEnumerable<WireMode> Modes => WireModeLoader.GetSorted(WireMode.Sets.NormalWires).Concat(WireModeLoader.GetSorted(WireMode.Sets.AshenWires));
