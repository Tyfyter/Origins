...
namespace Origins.Items.Other.Testing
{
	public class Willy_Aftershave : ModItem
	{
		...
		/*public override void MeleeEffects(Player player, Rectangle hitbox) { mod cannot load with this because "sparkle" does not exist. it is a good practice to ensure the mod can properly load before pushing commits.
