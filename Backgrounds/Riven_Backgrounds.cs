...
namespace Origins.Backgrounds {
	...
	public class Riven_Desert_Background : ModSurfaceBackgroundStyle {
		int? far;
		int? mid;
		int? near;
		public override int ChooseFarTexture() {
			return far ??= BackgroundTextureLoader.GetBackgroundSlot("Origins/Backgrounds/Riven_Desert_Background3");
		}

		public override int ChooseMiddleTexture() {
			return mid ??= BackgroundTextureLoader.GetBackgroundSlot("Origins/Backgrounds/Riven_Desert_Background2");
		}

		public override int ChooseCloseTexture(ref float scale, ref double parallax, ref float a, ref float b) {
			return near ??= BackgroundTextureLoader.GetBackgroundSlot("Origins/Backgrounds/Riven_Desert_Background");
		}
