...
namespace Origins.Walls {
	...
	public class Harmony_Brick_Wall_Safe : Harmony_Brick_Wall {
		...
		public override void SetStaticDefaults() {
			ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ItemType<Harmony_Brick_Wall_Item>();
