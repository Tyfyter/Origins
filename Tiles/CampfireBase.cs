...
namespace Origins.Tiles {
	public abstract class CampfireBase : ModTile {
		public abstract Vector3 Light { get; }
		public abstract Color MapColor { get; }
		public virtual LiquidPlacement WaterPlacement => LiquidPlacement.NotAllowed;
		public virtual LiquidPlacement LavaPlacement => LiquidPlacement.NotAllowed;
		private AutoLoadingAsset<Texture2D> flameTexture;
		public override void SetStaticDefaults() {
			...
			*/
			...
			// Etc
			AddMapEntry(MapColor, Language.GetText("ItemName.Campfire"));
