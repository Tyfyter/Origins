...
namespace Origins.Tiles {
	public abstract class SaplingBase : ModTile {
		public abstract Color MapColor { get; }
		public virtual bool IsPalm => false;
		public abstract int[] ValidAnchorTypes { get; }
		public override void SetStaticDefaults() {
			...
			AddMapEntry(MapColor, Language.GetText("MapObject.Sapling"));
		...
		public override void RandomUpdate(int i, int j) {
			...
			growSuccess = IsPalm ? WorldGen.GrowPalmTree(i, j) : WorldGen.GrowTree(i, j);
