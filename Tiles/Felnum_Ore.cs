...
namespace Origins.Tiles {
    ...
    public class Felnum_Ore : OriginTile {
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b) {
            ...
            if(v >= 1.99f&&Main.rand.Next(0,4)==0)Dust.NewDust(new Vector2(i*16-Main.rand.Next(0,16),j*16-Main.rand.Next(0,16)), 30, 30, 226, 0f, 0f, 0, Color.White, 0.5f);//Main.NewText($"{i},{j},{v}");
            if(v<0)v=0;
            r = 0.4f-(0.4f*v);
            g = 0.3f+(0.2f*v);
            b = 0.1f+(0.3f*v);
