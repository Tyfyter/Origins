...
namespace Origins.Tiles.Other {
	public class Shadow_Torch_Tile : OriginTile {
		...
		public override void SetStaticDefaults() {
			...
			// Assets
			if (!Main.dedServ) {
				RequestIfExists("Origins/Tiles/Other/Shadow_Torch_Tile_Flame", out flameTexture);
			}
	...
	public class Shadow_Torch : ModItem, ICustomWikiStat {
		public static Vector3 Light => new(-1f);
		public override void SetStaticDefaults() {
		...
		public override void SetDefaults() {
			...
			Item.DefaultToTorch(TileType<Shadow_Torch_Tile>(), 0, false);
