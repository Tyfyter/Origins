...
namespace Origins.Tiles.Ashen {
	public class Ashen_Torch_Tile : OriginTile {
		...
		public override float GetTorchLuck(Player player) => player.InModBiome<Ashen_Biome>().ToDirectionInt();
	...
	public class Ashen_Torch: ModItem, ICustomWikiStat {
		...
		public override void PostUpdate() {
			if (!Item.wet) Lighting.AddLight(Item.Center, Light);
		}

		public override void AddRecipes() {
			CreateRecipe(3)
			.AddIngredient(ItemID.Torch, 3)
			.AddIngredient(ItemType<Brown_Ice_Item>())
