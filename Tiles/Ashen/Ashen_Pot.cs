...
namespace Origins.Tiles.Ashen {
	public class Ashen_Pot : ModTile {
		public override string Texture => typeof(Defiled_Pot).GetDefaultTMLName();
	...
	public class Ashen_Pot_Item : TestingItem {
		public override string Texture => "Origins/Tiles/Defiled/Defiled_Pot";
		public override void SetDefaults() {
			Item.DefaultToPlaceableTile(ModContent.TileType<Ashen_Pot>());
		}
