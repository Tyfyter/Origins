...
namespace Origins.Tiles.Defiled {
	public class Defiled_Torch_Tile : OriginTile {
		...
		public override void SetStaticDefaults() {
			...
			// Assets
			if (!Main.dedServ) {
				RequestIfExists("Origins/Tiles/Defiled/Defiled_Torch_Tile_Flame", out flameTexture);
			}
		}
		...
		public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b) {
			...
			if (tile.TileFrameX < 66) {
				Vector3 light = Defiled_Torch.Light;
				r = light.X;
				g = light.Y;
				b = light.Z;
			}
	...
	public class Defiled_Torch : ModItem, ICustomWikiStat {
		...
		public override void SetDefaults() {
			...
			Item.DefaultToTorch(TileType<Defiled_Torch_Tile>(), 0, false);
			Item.value = 50;
		}
		...
		public override void AddRecipes() {
            ...
            CreateRecipe(3)
			.AddIngredient(ItemID.Torch, 3)
			.AddIngredient(TileItem.ItemType<Defiled_Stone>())
			.SortAfterFirstRecipesOf(ItemID.Torch)
			.Register();
