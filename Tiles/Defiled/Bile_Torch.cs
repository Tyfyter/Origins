...
namespace Origins.Tiles.Defiled {
	public class Bile_Torch_Tile : OriginTile {
		...
		public override void SetStaticDefaults() {
			...
			// Assets
			if (!Main.dedServ) {
				RequestIfExists("Origins/Tiles/Defiled/Bile_Torch_Tile_Flame", out flameTexture);
			}
		}
		...
		public override float GetTorchLuck(Player player) => player.InModBiome<Defiled_Wastelands>().ToInt();
		...
		public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b) {
			...
			if (tile.TileFrameX < 66) {
				Vector3 light = Bile_Torch.Light;
				r = light.X;
				g = light.Y;
				b = light.Z;
			}
	...
	public class Bile_Torch : ModItem, ICustomWikiStat {
		...
		public override void SetDefaults() {
			...
			Item.DefaultToTorch(TileType<Bile_Torch_Tile>(), 0, false);
		...
		public override void AddRecipes() {
			...
			.AddIngredient(ItemType<Black_Bile>())
