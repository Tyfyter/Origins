...
namespace Origins.Tiles.Dusk {
    public class Dusk_Stone : OriginTile {
		public override void SetStaticDefaults() {
			...
			ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ItemType<Dusk_Stone_Item>();
