...
namespace Origins.NPCs.Brine {
	public class Mildew_Creeper : Brine_Pool_NPC, IMeleeCollisionDataNPC, IWikiNPC, ICustomWikiStat {
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot) {
			...
			npcLoot.Add(ItemDropRule.ByCondition(OriginsModIntegrations.AprilFools.ToDropCondition(ShowItemDropInUI.WhenConditionSatisfied), ModContent.ItemType<Brine_Cheese>(), 50, 1, 3));
		}
