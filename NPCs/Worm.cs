...
namespace Origins.NPCs {
	...
	public abstract class Worm : ModNPC
	{
		...
		protected internal virtual void HeadAI() { }
	...
	public abstract class WormHead : Worm {
		...
		protected void HeadAI_CheckTargetDistance(ref bool collision) {
		...
		protected void HeadAI_Movement(bool collision) {
		...
		protected void HeadAI_Movement_HandleMovement(float dirX, float dirY, float length, float speed, float acceleration) {
	...
	public abstract class WormBody : Worm, IOnHitByNPC {
		...
		protected internal static void CommonAI_BodyTail(Worm worm) {
			...
			if (following is not null) {
				...
				// Assumes the sprite for the NPC points upward.  You might have to modify this line to properly account for your NPC's orientation
				worm.NPC.rotation = (float)Math.Atan2(dirY, dirX) + MathHelper.Pi;
