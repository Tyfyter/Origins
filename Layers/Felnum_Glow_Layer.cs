...
namespace Origins.Layers {
	public class Felnum_Glow_Layer : PlayerDrawLayer {
		AutoLoadingTexture eyeTexture = "Origins/Items/Armor/Felnum/Felnum_Glow_Eye";
		AutoLoadingTexture bodyTexture = "Origins/Items/Armor/Felnum/Felnum_Breastplate_Body_Glow";
		AutoLoadingTexture oldBodyTexture = "Origins/Items/Armor/Felnum/Ancient_Felnum_Breastplate_Body_Glow";
