...
public static class WikiCategories {
	...
	public const string GrabBag = "GrabBag";
	public const string SpecialEffectDye = "SpecialEffectDye";
	public const string Bar = "Bar";
	public const string Ore = "Ore";
	public const string Potion = "Potion";
	public const string Food = "Food";
	public const string PermaBoost = "PermaBoost";
	public const string BossSummon = "BossSummon";
	...
	public const string ToolWeapon = "ToolWeapon";

	// Armor
	public const string ArmorSet = "ArmorSet";
	public const string Armor = "Armor";
	public const string PostMLArmorSet = "PostMLArmorSet";

	// Armor Boosts
	public const string GenericBoostGear = "GenericBoostGear";
