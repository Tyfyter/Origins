...
public class MaxRoomCount : SerializableBreakDescriptor {
	protected override Accumulator<StructureInstance, bool> Create(string[] parameters, string originalText) => Create(int.Parse(parameters[0]));
